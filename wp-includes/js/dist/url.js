 ...
 * const authority2 = getAuthority( 'https://sagebuildersofidaho.com:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://sagebuildersofidaho.com:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://sagebuildersofidaho.com:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
...
function getQueryString(url) {
  ...
  try {
    query = new URL(url, 'http://sagebuildersofidaho.com').search.substring(1);
  } catch (error) {}
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://sagebuildersofidaho.com:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://sagebuildersofidaho.com:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'https://sagebuildersofidaho.com:8080/this/is/a/test.jpg' ); // 'test.jpg'
...
function getFilename(url) {
  ...
  try {
    filename = new URL(url, 'http://sagebuildersofidaho.com').pathname.split('/').pop();
  } catch (error) {}
